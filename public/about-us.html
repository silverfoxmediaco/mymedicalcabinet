...
<html lang="en">
    <head>
        ...
        <title>About Us | mymedicalcabinet.com</title>
        ...
        <div class="main">
            <div class="container">
                <header class="header-main">
                    ...
                    <div class="grid-logo">
                        <a href="index.html"><img class="logo" src="mymed100by50logo.png" alt="logo"></a>
                    </div>
                    <div class="grid-burger">
                        <nav>
                            <!-- Mobile Menu Start -->
                            <ul class="sidebar">
                                <li onclick="hideSideBar()"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a></li>
                            ...
                            <ul class="nav-list">
                                <li class="menu-button" onclick="showSideBar()">
                                    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                ...
                <section class="hero">
                    <div class="hero-section"><h1>About Us</h1>
                    
                    <h2>We know what it's like to go through a medical emergency.</h2>
                    <br>
                    <a href="become-a-member.html" class="grid-card-btn">Become a Member Today!</a>
                    </div>
                </section>
                <div>
